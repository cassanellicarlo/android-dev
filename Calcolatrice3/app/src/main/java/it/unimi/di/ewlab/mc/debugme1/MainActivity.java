...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // Controllo che ci sia un numero, altrimenti mostro un Toast
    ...
    public void moltiplica(View view) {

        // Al click del bottone moltiplica faccio partire l'altra activity
        Intent intent=new Intent(this,MoltiplicaActivity.class);
